  ...
  return (
    <div className="mt-8 bg-primary pt-9">
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          <div className="md:w-[350px]">
            ...
            <p className="mt-2 text-md shadow-none font-normal text-black">
              ...
              them with outstanding service, we wouldn’t have 10,000+ clients
              all around the UK.
            </p>
          </div>
          <div className="md:w-[316px]">
            ...
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a
                  href="https://www.google.com/maps/place/20-22+Wenlock+Rd,+London+N1+7GU,+UK/@51.530613,-0.0935057,17z/data=!3m1!4b1!4m5!3m4!1s0x48761ca0ab2ddc0b:0xe07efba243f983f1!8m2!3d51.530613!4d-0.0935057"
                  className=" text-[14px] font-medium text-black"
                >
                  20, 22 Wenlock Rd, London N1 7GU, UK
                </a>
                <p className=" text-[12px] font-medium text-black">Address</p>
              </div>
            </div>
          </div>
        ...
        <hr className="mt-[30px] sm:mt-[40px]  border-t-2 border-dashed border-black h-[5px]" />
        {/* Disclaimer */}
